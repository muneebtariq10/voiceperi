...
export class PrintEZKnowledgeAdapter implements IKnowledgeProvider {
  ...
  private readonly knowledgeRepository: KnowledgeEntry[] = [
    ...
    {
      id: 'EZ_REWARDS_PROGRAM',
      category: 'EZ Rewards Loyalty & Cash Back Program',
      keywords: [
        'ez rewards',
        'reward',
        'rewards',
      ...
      answer:
        'PrintEZ’s official loyalty program, EZ Rewards, applies across all 50 U.S. states with zero geographic restrictions! Registered account customers automatically earn 3% Cash Back on every qualifying order placed via standard account checkout (credit card or direct invoice) to redeem on future purchases. Please note that external third-party checkouts (such as PayPal, Amazon Pay, or Google Checkout) are excluded from earning or redeeming EZ Rewards.',
      url: 'https://www.printez.com/ez-rewards.html',
    },
    {
      id: 'DIRECT_ORDER_STOCK_ITEMS',
      category: 'Direct-Order Stock vs. Custom Personalized Items',
      keywords: [
        'direct order',
        'add to cart',
        'order now',
      ...
      answer:
        'While custom commercial check printing and accounting forms display a "Personalize Now" button requiring lot quantity and bank routing details, PrintEZ also maintains over 160 off-the-shelf physical stock products that feature a direct "Add to Cart / Order Now" button! These include manual check leather binders, 7-ring organizers, retail pricing label guns, self-inking stamp ink refills, and executive gift baskets, all available for immediate purchase at fixed unit catalog pricing without any customization requirements.',
