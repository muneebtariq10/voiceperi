...
export default function SentimentAnalysisCard({ data }: { data: string[] }) {
  ...
  return (
    <div className="h-full rounded-xl bg-card p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 flex flex-col justify-between">
      {/* Header */}
      ...
      <TooltipProvider>
        <div className="mt-8 flex items-center gap-2 h-[32px] w-full overflow-visible">
          ...
          <Tooltip>
            ...
            <TooltipContent className="bg-card border text-gray-900 shadow-md">
